...
/*
    ...
    Cmdline:
        sokol-shdc --input shaders/cube_sapp.glsl --output include/cube_sapp.glsl.h --format sokol --slang glsl410
...
#error "Please include sokol_gfx.h before cube_sapp.glsl.h"
#endif
