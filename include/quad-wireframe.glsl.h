...
/*
    ...
    Cmdline:
        sokol-shdc --input shaders/quad-wireframe.glsl --output include/quad-wireframe.glsl.h --format sokol --slang glsl410
...
#error "Please include sokol_gfx.h before quad-wireframe.glsl.h"
#endif
