...
/*
    ...
    Cmdline:
        sokol-shdc --input shaders/quad_textured.glsl --output include/quad_textured.glsl.h --format sokol --slang glsl410

    Overview:
    =========
    Shader program: 'quad_textured':
        Get shader desc: quad_textured_shader_desc(sg_query_backend());
        Vertex Shader: vs
        Fragment Shader: fs
        Attributes:
            ATTR_quad_textured_position => 0
            ATTR_quad_textured_texcoord0 => 1
    Bindings:
        Texture 'tex':
...
#error "Please include sokol_gfx.h before quad_textured.glsl.h"
#endif
...
#endif
#endif
#define ATTR_quad_textured_position (0)
#define ATTR_quad_textured_texcoord0 (1)
#define VIEW_tex (0)
#define SMP_samp (0)
/*
    #version 410
...
*/
static const uint8_t vs_source_glsl410[205] = {
...
static const uint8_t fs_source_glsl410[175] = {
    ...
    0x73,0x61,0x6d,0x70,0x2c,0x20,0x75,0x76,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x00,
};
static inline const sg_shader_desc* quad_textured_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_GLCORE) {
        ...
        if (!valid) {
            ...
            desc.label = "quad_textured_shader";
        }
        return &desc;
    }
    return 0;
